...
class Policy_net:
    def __init__(self, name: str, env, env_name):
        """
        :param name: string
        :param env: gym env
        """
        ...
        with tf.variable_scope(name):
            ...
            with tf.variable_scope('policy_net'):
                ...
                layer_3 = tf.layers.dense(inputs=layer_2, units=action_space_count, activation=tf.tanh)
                self.act_probs = tf.layers.dense(inputs=layer_3, units=action_space_count, activation=tf.nn.softmax)
